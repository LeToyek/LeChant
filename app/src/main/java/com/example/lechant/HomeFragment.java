...
public class HomeFragment extends Fragment implements View.OnClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Button btnHardBass = view.findViewById(R.id.btn_hard_bass);
        btnHardBass.setOnClickListener(this);
    }
    ...
    public void onClick(View view) {
        if(view.getId() == R.id.btn_classical){
            ...
            }else if(view.getId() == R.id.btn_hard_bass){
            ...
            if (fragmentManager != null){
                fragmentManager
                        .beginTransaction()
                        .replace(R.id.frame_container,hardBass,HardBass.class.getSimpleName())
                        .addToBackStack(null)
                        .commit();
            }
        }
